this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
  ...
  var wordleStartDate = new Date(2021, 5, 19, 12, 0, 0, 0);
  ...
  function Da(e) {
    var a, s = Ga(e);
    return a = (Math.abs(La.length - s)) % La.length, La[a]
  }

  function Ga(e) {
    return getDateWordleIndex(wordleStartDate, e)
  }
    ...
    ts = function (e) {
      ...
      function t() {
        ...
        s(this, t), n(p(e = a.call(this)), "tileIndex", 0), n(p(e), "rowIndex", 0), n(p(e), "solution", void 0), n(p(e), "boardState", void 0), n(p(e), "evaluations", void 0), n(p(e), "canInput", !0), n(p(e), "gameStatus", Za), n(p(e), "letterEvaluations", {}), n(p(e), "$board", void 0), n(p(e), "$keyboard", void 0), n(p(e), "$game", void 0), n(p(e), "today", void 0), n(p(e), "lastPlayedTs", void 0), n(p(e), "lastCompletedTs", void 0), n(p(e), "hardMode", void 0), n(p(e), "dayOffset", void 0), e.attachShadow({
          mode: "open"
          // TODO, I think we can try with how we set today?
        }), e.today = new Date()+1000*60*60*12*1;
        var o = za();
        return e.lastPlayedTs = o.lastPlayedTs, !e.lastPlayedTs || getDateWordleIndex(new Date(e.lastPlayedTs), e.today) >= 1 ? (e.boardState = new Array(6).fill(""), e.evaluations = new Array(6).fill(null), e.solution = Da(e.today), e.dayOffset = Ga(e.today), e.lastCompletedTs = o.lastCompletedTs, e.hardMode = o.hardMode, e.restoringFromLocalStorage = !1, ja({
          rowIndex: e.rowIndex,
      ...
      return o(t, [{
        ...
        value: function () {
          if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
            ...
            if (i || l) Va({
              isWin: l,
              isStreak: !!this.lastCompletedTs && 1 === getDateWordleIndex(new Date(this.lastCompletedTs), new Date),
              numGuesses: this.rowIndex
            }), ja({
              lastCompletedTs: Date.now() + 1000*12*60*60*1
            ...
            this.tileIndex = 0, this.canInput = !1, ja({
              ...
              lastPlayedTs: Date.now() + 1000*12*60*60*1
            })
          }
        }
      }, {
  ...
  var Ys = 6e4,
    ...
    Us = function (e) {
      ...
      function t() {
        ...
        var o = new Date;
        // TODO try changing the time on o.setDate 
        // o.setDate(o.getDate() + 1);
        // o.setTime(o.getTime() + 1000*60*60*12*1);
        return o.setDate(o.getDate() + 1), o.setHours(12, 0, 0, 0), e.targetEpochMS = o.getTime() , e
        // return o, o.setHours(12, 0, 0, 0), e.targetEpochMS = o.getTime()+1000*60*60*12*1 , e
